...
function formatLocalTtsWarning(warning: string | null): string {
  if (!warning) {
    return "고품질 로컬 음성이 준비되지 않아 음성 응답을 잠시 중지했습니다. 기본 여성 음성 fallback은 사용하지 않습니다.";
  }
  if (warning.includes('reference') || warning.includes('prompt') || warning.includes('voice')) {
    return "고품질 음성 reference를 확인해야 합니다. 준비 전에는 기본 여성 음성으로 대체하지 않습니다.";
  }
  if (warning.includes('model')) {
    return "고품질 음성 모델을 찾지 못했습니다. 준비 전에는 기본 여성 음성으로 대체하지 않습니다.";
  }
  if (warning.includes('runtime') || warning.includes('repo')) {
    return "고품질 음성 런타임 설정이 필요합니다. 준비 전에는 기본 여성 음성으로 대체하지 않습니다.";
  }
  return "고품질 로컬 음성이 준비되지 않아 음성 응답을 잠시 중지했습니다. 기본 여성 음성 fallback은 사용하지 않습니다.";
}
