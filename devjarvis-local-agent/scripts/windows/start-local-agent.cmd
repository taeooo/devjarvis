...
if "%DEVJARVIS_LOCAL_AGENT_STT_PROVIDER%"=="" set "DEVJARVIS_LOCAL_AGENT_STT_PROVIDER=placeholder"
if "%DEVJARVIS_LOCAL_AGENT_TTS_PROVIDER%"=="" set "DEVJARVIS_LOCAL_AGENT_TTS_PROVIDER=placeholder"
if "%DEVJARVIS_LOCAL_AGENT_TTS_MELOTTS_DEVICE%"=="" set "DEVJARVIS_LOCAL_AGENT_TTS_MELOTTS_DEVICE=cpu"
if "%DEVJARVIS_LOCAL_AGENT_TTS_MELOTTS_SPEED%"=="" set "DEVJARVIS_LOCAL_AGENT_TTS_MELOTTS_SPEED=0.92"
